...
class ReviewerBab1 extends Model
{
    ...
    protected $fillable = ['id_reviewer','id_proposal','nama_pt','alamat_pt','ijin_operasional_pt','scan_ijin_operasional_pt','status_akreditasi_institusi','scan_status_akreditasi_institusi','nama_pt_mitra','alamat_pt_mitra','ijin_operasional_pt_mitra','scan_ijin_operasional_pt_mitra','status_akreditasi_institusi_mitra','scan_status_akreditasi_institusi_mitra','negara_mitra','peringkat_internasional_mitra','nama_prodi','nama_prodi_mitra','akreditasi_prodi','akreditasi_prodi_mitra','scan_sk_akreditasi_prodi','scan_sk_akreditasi_prodi_mitra','scan_ijin_operasional_prodi','scan_ijin_operasional_prodi_mitra','proposal_usulan_kerjsama','status_proposal','komentar_bab1'];
