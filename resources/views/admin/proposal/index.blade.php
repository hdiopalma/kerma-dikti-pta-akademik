        ...
        <ul class="nav nav-tabs" id="proposal-tabs" role="tablist">
            <li class="nav-item">
                <a
                    ...
                    id="proposal-tabs-table-tab"
                    data-toggle="pill"
                    href="#proposal-tabs-table"
                    role="tab"
                    aria-controls="proposal-tabs-table"
                    aria-selected="true"
                >
            ...
            <li class="nav-item">
                <a
                    class="nav-link"
                    id="proposal-tabs-add-tab"
                    data-toggle="pill"
                    href="#proposal-tabs-add"
                    role="tab"
                    aria-controls="proposal-tabs-add"
                    aria-selected="false"
                >
