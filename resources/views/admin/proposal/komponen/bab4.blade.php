<div class="col-12 col-sm-12 col-md-12">
    <div class="card">
                    ...
                    <div id="panelKPKS-collapse" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label text-bold">Rencana Pelaksanaan Pembelajaran<code>*</code></div>
                                <div class="col-sm-9">
                                    <div id="RPP" class="border-bottom border-grey pb-2 pt-2">
                                        {!! (isset($proposal->bab4->rencana_pelaksanaan_pembelajaran) && trim($proposal->bab4->rencana_pelaksanaan_pembelajaran) !== "") ? $proposal->bab4->rencana_pelaksanaan_pembelajaran : "<b class='text-red'> BELUM DIISI </b>" !!}
                                    </div>
                                </div>
                            </div>
                            <!-- Desain Kurikulum -->
                                    ...
                                    <div class="row border-bottom border-grey">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div id="KurikulumGabungan" class="pb-2 pt-2">
                                                @if (isset($proposal->bab4->scan_desain_kurikulum_gabungan) && trim($proposal->bab4->scan_desain_kurikulum_gabungan) !== "")
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div id="JenisKerjaSama" class="border-bottom border-grey pb-2 pt-2">
                                        {!! (isset($proposal->bab4->kerjasama->jenis_kerjasama) && trim($proposal->bab4->kerjasama->jenis_kerjasama) !== "") ? $proposal->bab4->kerjasama->jenis_kerjasama : "<b class='text-red'> BELUM DIISI </b>" !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label text-bold">Jumlah Ijazah yang Akan Diterbitkan<code>*</code></div>
                                <div class="col-sm-9 border-bottom border-grey d-flex align-items-center">
                                    <div id="JumlahIjazah" class="pb-2 pt-2">
                                        {!! (isset($proposal->bab4->jumlah_ijazah_terbit) && trim($proposal->bab4->jumlah_ijazah_terbit) !== "") ? $proposal->bab4->jumlah_ijazah_terbit : "<b class='text-red'> BELUM DIISI </b>" !!}
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 border-right">
                                            ...
                                            <div id="TTDNamaPT" class="pb-2 pt-2 pl-0 pr-2 border-bottom">
                                                {!! (isset($proposal->bab4->nama_ttd_ijazah_pt) && trim($proposal->bab4->nama_ttd_ijazah_pt) !== "") ? $proposal->bab4->nama_ttd_ijazah_pt : "<b class='text-red'> BELUM DIISI </b>" !!}
                                            </div>
                                            <br> Jabatan:
                                            <div id="TTDJabatanPT" class="pb-2 pt-2 pl-0 pr-2 border-bottom">
                                                {!! (isset($proposal->bab4->jabatan_ttd_ijazah_pt) && trim($proposal->bab4->jabatan_ttd_ijazah_pt) !== "") ? $proposal->bab4->jabatan_ttd_ijazah_pt : "<b class='text-red'> BELUM DIISI </b>" !!}
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div id="TTDNamaPTMitra" class="pb-2 pt-2 border-bottom ">
                                                {!! (isset($proposal->bab4->nama_ttd_ijazah_mitra) && trim($proposal->bab4->nama_ttd_ijazah_mitra) !== "") ? $proposal->bab4->nama_ttd_ijazah_mitra : "<b class='text-red'> BELUM DIISI </b>" !!}
                                            </div>
                                            <br> Jabatan:
                                            <div id="TTDJabatanPTMitra" class="pb-2 pt-2 pl-0 pr-2 border-bottom">
                                                {!! (isset($proposal->bab4->jabatan_ttd_ijazah_mitra) && trim($proposal->bab4->jabatan_ttd_ijazah_mitra) !== "") ? $proposal->bab4->jabatan_ttd_ijazah_mitra : "<b class='text-red'> BELUM DIISI </b>" !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label text-bold">Kriteria Calon Mahasiswa<code>*</code></div>
                                <div class="col-sm-9">
                                    <div id="KriteriaCalonMahasiswa" class="border-bottom border-grey pb-2 pt-2">
                                        {!! (isset($proposal->bab4->kriteria_calon_mahasiswa) && trim($proposal->bab4->kriteria_calon_mahasiswa) !== "") ? $proposal->bab4->kriteria_calon_mahasiswa : "<b class='text-red'> BELUM DIISI </b>" !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div id="ProsesSeleksi" class="border-bottom border-grey pb-2 pt-2">
                                        {!! (isset($proposal->bab4->proses_seleksi) && trim($proposal->bab4->proses_seleksi) !== "") ? $proposal->bab4->proses_seleksi : "<b class='text-red'> BELUM DIISI </b>" !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div id="SkemaPembiayaan" class="border-bottom border-grey pb-2 pt-2">
                                        {!! (isset($proposal->bab4->skema_pembiayaan) && trim($proposal->bab4->skema_pembiayaan) !== "") ? $proposal->bab4->skema_pembiayaan : "<b class='text-red'> BELUM DIISI </b>" !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label text-bold">Berkas penjadwalan program kerjasama<code>*</code></div>
                            ...
                            <!-- Berkas SKPI -->
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label text-bold">Surat Keterangan Pendamping Ijazah (SKPI)<code>*</code></div>
                                <div class="col-sm-9 d-flex align-items-center">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 col-form-label text-bold">Keberlanjutan untuk studi lanjut<code>*</code></div>
                                <div class="col-sm-9">
                                    <div id="KeberlanjutanStudiLanjut" class="border-bottom border-grey pb-2 pt-2">
                                        {!! (isset($proposal->bab4->keberlanjutan_studi_lanjut) && trim($proposal->bab4->keberlanjutan_studi_lanjut) !== "") ? $proposal->bab4->keberlanjutan_studi_lanjut : "<b class='text-red'> BELUM DIISI </b>" !!}
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="StudiLanjutMOA" class="pb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-form-label text-bold">
                                                <input type="radio" name="studi_lanjut_moa" value="Ya" {{ (isset($proposal->bab4->studi_lanjut_moa) && $proposal->bab4->studi_lanjut_moa == 1) ? "checked" : "" }} disabled> Ya &nbsp;
                                                <input type="radio" name="studi_lanjut_moa" value="Tidak" {{ (isset($proposal->bab4->studi_lanjut_moa) && $proposal->bab4->studi_lanjut_moa == 0) ? "checked" : "" }} disabled> Tidak
        ...
        <div class="card-footer">
            <!-- Bab sebelumnya -->
            <a href="{{ route('admin.proposal.viewBab3', encrypt($proposal->id)) }}" class="btn btn-primary float-left">Sebelumnya</a>
