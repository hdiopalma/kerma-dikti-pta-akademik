                                            ...
                                            <div class="input-group">
                                                <div class=" pt-1">
                                                    @isset($proposal->bab1->scan_ijin_operasional_pt)
                                                        <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_ijin_operasional_pt)) }}"
                                            ...
                                            <div class="input-group">
                                                <div class=" pt-1">
                                                    @isset($proposal->bab1->scan_status_akreditasi_institusi)
                                                        <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_status_akreditasi_institusi)) }}"
                                                            class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                                    @else
                                                        <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
                                            ...
                                            <div class="input-group">
                                                <div class=" pt-1">
                                                    @isset($proposal->bab1->scan_ijin_operasional_pt_mitra)
                                                        <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_ijin_operasional_pt_mitra)) }}"
                                                            class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                                    @else
                                                        <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
                                            ...
                                            <div class="input-group">
                                                <div class=" pt-1">
                                                    @isset($proposal->bab1->scan_status_akreditasi_institusi_mitra)
                                                        <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_status_akreditasi_institusi_mitra)) }}"
                                                            class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                                    @else
                                                        <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="pt-2">
                                            ...
                                            @isset($proposal->bab1->scan_sk_akreditasi_prodi)
                                                <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_sk_akreditasi_prodi)) }}"
                                                    class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                            @else
                                                <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
                                ...
                                <div class="col-sm-4 pt-1">
                                    ...
                                    <div class="pt-2">
                                        ...
                                        @isset($proposal->bab1->scan_sk_akreditasi_prodi_mitra)
                                            <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_sk_akreditasi_prodi_mitra)) }}"
                                                class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                        @else
                                            <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
                                ...
                                <div class="col-sm-4 border-right border-top pt-1">
                                    ...
                                    <div class="pt-2">
                                        @isset($proposal->bab1->scan_ijin_operasional_prodi)
                                            <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_ijin_operasional_prodi)) }}"
                                                class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                        @else
                                            <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
                                ...
                                <div class="col-sm-4 border-top pt-1">
                                    ...
                                    <div class="pt-2">
                                        @isset($proposal->bab1->scan_ijin_operasional_prodi_mitra)
                                            <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_ijin_operasional_prodi_mitra)) }}"
                                                class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                        @else
                                            <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 pt-1 d-flex align-items-center">
                                    @isset($proposal->bab1->proposal_usulan_kerjsama)
                                        <a target="_blank" href="{{ route('verifikator.proposal.download', encrypt($proposal->bab1->scan_proposal_usulan_kerjsama)) }}"
                                            class="btn btn-primary btn-sm">Download <i
                                                            class="fas fa-file-pdf text-white"></i></a>
                                    @else
                                        <button class="btn btn-danger btn-sm" disabled>Belum Upload <i
