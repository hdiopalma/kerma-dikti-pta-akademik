    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                ...
                'created_at' => now(),
                'updated_at' => now(),
                'id_bab4' => 3, // Assuming bab4 table has an appropriate ID
                'id_jenis_kerjasama' => 1, // Assuming jenis_kerjasama table has an appropriate ID
                'id_universitas' => 1, // Assuming universitas table has an appropriate ID
                'id_bab1' => 3, // Assuming bab1 table has an appropriate ID
                'id_bab2' => 3, // Assuming bab2 table has an appropriate ID
            ...
            [
                ...
                'created_at' => now(),
                'updated_at' => now(),
                'id_bab4' => 4, // Assuming bab4 table has an appropriate ID
                'id_jenis_kerjasama' => 3, // Assuming jenis_kerjasama table has an appropriate ID
                'id_universitas' => 2, // Assuming universitas table has an appropriate ID
                'id_bab1' => 4, // Assuming bab1 table has an appropriate ID
                'id_bab2' => 4, // Assuming bab2 table has an appropriate ID
            ...
            [
                ...
                'created_at' => now(),
                'updated_at' => now(),
                'id_bab4' => 5, // Assuming bab4 table has an appropriate ID
                'id_jenis_kerjasama' => 2, // Assuming jenis_kerjasama table has an appropriate ID
                'id_universitas' => 2, // Assuming universitas table has an appropriate ID
                'id_bab1' => 5, // Assuming bab1 table has an appropriate ID
                'id_bab2' => 5, // Assuming bab2 table has an appropriate ID
