...
class Bab4Seeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                'rencana_pelaksanaan_pembelajaran' => null,
                'scan_desain_kurikulum_pt' => null,
                'scan_desain_kurikulum_mitra' => null,
                'scan_desain_kurikulum_gabungan' => null,
                'jumlah_ijazah_terbit' => null,
                'nama_ttd_ijazah_pt' => null,
                'nama_ttd_ijazah_mitra' => null,
                'jabatan_ttd_ijazah_pt' => null,
                'jabatan_ttd_ijazah_mitra' => null,
                'kriteria_calon_mahasiswa' => null,
                'proses_seleksi' => null,
                'skema_pembiayaan' => null,
                'file_penjadwalan_kerjasama' => null,
                'file_skpi' => null,
                'keberlanjutan_studi_lanjut' => null,
                'studi_lanjut_moa' => '1',
                'created_at' => now(),
                'updated_at' => now(),
                'id_jenis_kerjasama' => null,
            ],
            [
                'rencana_pelaksanaan_pembelajaran' => null,
                'scan_desain_kurikulum_pt' => null,
